...
namespace IIS.Prilozhenie_03
{
    ...
    [View("ТЧФактВыпРE", new string[] {
            ...
            "СпрТипТрансСр as \'Тип транспортного средство\'",
            "СпрТипТрансСр.Наименование as \'Тип транспортного средство\'",
    ...
    [MasterViewDefineAttribute("ТЧФактВыпРE", "СпрТранспСр", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Транспортное средство")]
    [MasterViewDefineAttribute("ТЧФактВыпРE", "СпрТипТрансСр", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Тип транспортного средство")]
    ...
    public class ТЧФактВыпР : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_03.ФактВыполРаб fФактВыполРаб;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Prilozhenie_03.ФактВыполРаб.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ФактВыполРаб"})]
        public virtual IIS.Prilozhenie_03.ФактВыполРаб ФактВыполРаб
        {
            get
            {
                ...
                IIS.Prilozhenie_03.ФактВыполРаб result = this.fФактВыполРаб;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧФактВыпРE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧФактВыпРE", typeof(IIS.Prilozhenie_03.ТЧФактВыпР));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧФактВыпР : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Prilozhenie_03.DetailArrayOfТЧФактВыпР members)

        // *** End programmer edit section *** (IIS.Prilozhenie_03.DetailArrayOfТЧФактВыпР members)
        ...
        /// </summary>
        public DetailArrayOfТЧФактВыпР(IIS.Prilozhenie_03.ФактВыполРаб fФактВыполРаб) : 
                base(typeof(ТЧФактВыпР), ((ICSSoft.STORMNET.DataObject)(fФактВыполРаб)))
        {
        }
        
        public IIS.Prilozhenie_03.ТЧФактВыпР this[int index]
        {
            get
            {
                return ((IIS.Prilozhenie_03.ТЧФактВыпР)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Prilozhenie_03.ТЧФактВыпР dataobject)
        {
